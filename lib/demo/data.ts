...
Dana`,
  ...
  },
  {
    ...
    folder: "inbox",
    from: "Ravi Shankar",
    fromEmail: "ravi@vizcom.com",
    to: "dana@vizcom.com",
    subject: "Kestrel trial seats — can we extend?",
    date: "2026-08-17",
    body: `Their studio director asked for two more weeks on the trial. I said yes. Flagging so the close date in the forecast does not surprise you on Thursday.
...
Ravi`,
  ...
  },
  {
    id: "e9",
    folder: "inbox",
    from: "Design Week Digest",
    fromEmail: "hello@designweekdigest.com",
    to: "dana@vizcom.com",
    subject: "Who is hiring in industrial design this month",
    date: "2026-08-16",
    body: `Forty-one open ID roles this month, weighted heavily toward footwear and connected fitness. Full list inside.`,
    read: true,
  },
  {
    id: "e10",
    ...
    to: "dana@vizcom.com",
    subject: "Invitation: Halcyon Audio intro call @ Wed Aug 19, 10:00",
    date: "2026-08-14",
    body: `Priya Raghavan has invited you to Halcyon Audio intro call.

Wed Aug 19, 2026 10:00 – 10:30 (PDT)
Video call link included.`,
  ...
  },
  {
    ...
    folder: "inbox",
    from: "Vizcom Support",
    fromEmail: "support@vizcom.com",
    to: "dana@vizcom.com",
    subject: "Ticket #4821 resolved — seat count on the Motiva account",
    date: "2026-08-12",
    body: `The extra five seats are provisioned. Nothing further needed from you.`,
    read: true,
  },
  {
    id: "e7",
