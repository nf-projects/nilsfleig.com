			...
			<article className="prose prose-invert prose-zinc max-w-none">
				...
				<div className="space-y-6">
					...
					<p className="text-zinc-300 leading-relaxed font-mono mt-6">
						...
						latest SOTA models. It also feels like some of the built-in models
						in Github Copilot like Sonnet 3.5 are weaker than in the API
						directly, probably because of a strict system prompt.
					</p>
