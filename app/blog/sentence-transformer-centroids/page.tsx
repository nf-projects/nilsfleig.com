...
export default function SentenceTransformerCentroidsBlog() {
	return (
		<div className="mx-auto max-w-2xl pb-12">
			<article className="prose prose-invert prose-zinc max-w-none">
				...
				<p className="text-zinc-500 font-mono mb-12">February 10, 2024</p>
				...
				<Image
					...
					alt="Sentence Transformer Centroids"
					width={800}
					height={400}
